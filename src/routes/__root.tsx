...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WonderLearn — Magical Learning for Kids" },
      {
        name: "description",
        content:
          "A magical world where learning feels like an adventure. Stories, games and guided discovery for kids aged 4-12.",
      },
      { name: "author", content: "WonderLearn" },
      { property: "og:title", content: "WonderLearn — Magical Learning for Kids" },
      {
        property: "og:description",
        content: "A magical world where learning feels like an adventure.",
      },
